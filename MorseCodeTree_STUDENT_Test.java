...
public class MorseCodeTree_STUDENT_Test {
	...
	{
		assertEquals(tree.getRoot().getLChild().getData(),"e");
		assertEquals(tree.getRoot().getRChild().getData(), "t");
		assertEquals(tree.getRoot().getRChild().getRChild().getLChild().getLChild().getData(),"z");
	}
